 ...
 *
* @author fanghj
 *@time 2014-3-24 下午4:30:02
 */
public class S20020Loan implements Serializable{

	private static final long serialVersionUID = 4585564924666044425L;
     ...
     * 展期本金金额
     */
    public BigDecimal resch_init_prin;

    /**
     * 展期生效日期
     */
    public Date resch_date;
     ...
     * 展期前分期总手续费
     */
    public BigDecimal bef_resch_init_fee1;
	...
	public BigDecimal getResch_init_prin() {
		return resch_init_prin;
	}

	public void setResch_init_prin(BigDecimal resch_init_prin) {
		this.resch_init_prin = resch_init_prin;
	}

	public Date getResch_date() {
		return resch_date;
	}

	public void setResch_date(Date resch_date) {
		this.resch_date = resch_date;
	}
	...
	public BigDecimal getBef_resch_init_fee1() {
		return bef_resch_init_fee1;
	}

	public void setBef_resch_init_fee1(BigDecimal bef_resch_init_fee1) {
		this.bef_resch_init_fee1 = bef_resch_init_fee1;
	}
