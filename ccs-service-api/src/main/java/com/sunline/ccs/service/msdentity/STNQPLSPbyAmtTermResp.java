 ...
 *
 */
public class STNQPLSPbyAmtTermResp extends MsResponseInfo implements Serializable {
	...
	*/
	 ...
	 * 行政区划列表
	 */
	@JsonProperty(value="CHINA_DIVISION_LIST")
	public List<String> chinaDivisionList;
	 ...
	 * 合同模板编号
	 */
	@JsonProperty(value="CONTRACT_TEMPLATE_ID")
	...
	*/
	...
	public List<String> getChinaDivisionList() {
		return chinaDivisionList;
	}

	public void setChinaDivisionList(List<String> chinaDivisionList) {
		this.chinaDivisionList = chinaDivisionList;
	}
	...
	public void setAnnualFeeChargeMtd(FirstCardFeeInd firstCardFeeInd) {
		this.annualFeeChargeMtd = firstCardFeeInd;
	}
	...
	public void setPrepayPkgAmt(BigDecimal prepayPkgFeeAmount) {
		this.prepayPkgAmt = prepayPkgFeeAmount;
	}
	...
	public void setPrepayPkgRate(BigDecimal prepayPkgFeeAmountRate) {
		this.prepayPkgRate = prepayPkgFeeAmountRate;
	}
