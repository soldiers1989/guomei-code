...
public class TFRLargeCaseLoanReq extends MsRequestInfo {
...
//	public BigDecimal agreeRate;
	 ...
	 * 
	 */
	@Check(lengths=12,regular="^(([1-9]\\d*)|0)(\\.(\\d){1,8})?$")
	 ...
	 */
	@Check(lengths=12,notEmpty=false,regular="^(([1-9]\\d*)|0)(\\.(\\d){1,8})?$")
	@JsonProperty(value="REPLACE_PENALTY_RATE")
	...
	public BigDecimal getReplacePenaltyRate() {
		return replacePenaltyRate;
	}
	/**
	 * 代收罚息利率
	 * 
	 */
	public void setReplacePenaltyRate(BigDecimal replacePenaltyRate) {
		this.replacePenaltyRate = replacePenaltyRate;
	}
