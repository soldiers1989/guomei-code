...
public class S13060Resp implements Serializable {
	...
	public ArrayList<S13060Txn> txns;
	...
	public ArrayList<S13060Txn> getTxns() {
		return txns;
	}
	...
	public void setTxns(ArrayList<S13060Txn> txns) {
		this.txns = txns;
	}
