...
public class S14001Resp implements Serializable {
	...
	public ArrayList<S14001Card> cards;
	...
	public ArrayList<S14001Card> getCards() {
		return cards;
	}
	...
	public void setCards(ArrayList<S14001Card> cards) {
		this.cards = cards;
	}
