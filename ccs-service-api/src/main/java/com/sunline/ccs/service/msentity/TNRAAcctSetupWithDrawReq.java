...
public class TNRAAcctSetupWithDrawReq extends MsRequestInfo {
	/**
	 * 申请单编号
	 */
	...
	/**
	 * 	WORK_PROVINCE	单位所在省	VARCHAR2(20)	N
	 */
	@Check(lengths=20, notEmpty=false)
	@JsonProperty(value="WORK_PROVINCE")
	public String workProvince;
	/**
	 * 	WORK_CITY	单位所在市	VARCHAR2(20)	N
	 */
	@Check(lengths=20, notEmpty=false)
	@JsonProperty(value="WORK_CITY")
	public String workCity;
	/**
	 * 	WORK_ZONE	单位所在区/县	VARCHAR2(20)	N
	 */
	@Check(lengths=20, notEmpty=false)
	@JsonProperty(value="WORK_ZONE")
	...
	/**
	 * LOAN_DAYS	贷款总天数 	VARCHAR2(3)	Y
	 */
	@Check(lengths=3, notEmpty=true, isNumber=true)
	@JsonProperty(value="LOAN_DAYS")
...
//	@JsonProperty(value="STAMP_AMT")
	...
	/**
	 * 	COUPON_TYPE	优惠券类型	VARCHAR2(1)	N	1折扣券2抵用券
	 */
	@Check(lengths=1, regular="^[12]$")
	@JsonProperty(value="COUPON_TYPE")
	public String couponType;
	
	/**
	 * 	COUPON_AMOUNT	优惠券面值	DECIMAL(12,8)	N	折扣比例/抵扣金额
	 */
	@Check(lengths=12, notEmpty=false, regular="^(([1-9]\\d*)|0)(\\.(\\d){1,8})?$")
