 ...
 *
* @author fanghj
 *@time 2014-6-4 下午9:41:02
 */
public class S13002LoanFeeDef implements Serializable{

	private static final long serialVersionUID = 4278195896198050420L;
	 ...
	 * 最大允许分期比例
	 */
	public BigDecimal max_amount_rate;
	...
	public BigDecimal getMax_amount_rate() {
		return max_amount_rate;
	}

	public void setMax_amount_rate(BigDecimal max_amount_rate) {
		this.max_amount_rate = max_amount_rate;
	}
