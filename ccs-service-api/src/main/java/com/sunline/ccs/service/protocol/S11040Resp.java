...
public class S11040Resp implements Serializable {
	...
	public ArrayList<S11040Contact> contacts;
	...
	public ArrayList<S11040Contact> getContacts() {
		return contacts;
	}
	...
	public void setContacts(ArrayList<S11040Contact> contacts) {
