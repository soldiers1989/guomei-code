...
public class OA292SendMsRpt implements Tasklet  {
	...
	public RepeatStatus execute(StepContribution contribution,
		...
		String uploadFileAbsltPath = batchWorkDir + File.separator + fileTools.genBatchDatePrefix() + File.separator + "msUpload" + File.separator;
		String uploadingAbsltPath = batchWorkDir + File.separator + fileTools.genBatchDatePrefix() + File.separator + "msUploading" + File.separator;
