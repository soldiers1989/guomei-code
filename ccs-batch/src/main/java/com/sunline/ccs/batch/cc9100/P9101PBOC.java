 ...
 * @see 描述：人行征信报送文件
 *
 * @see 创建日期：   2015-6-24下午2:43:54
 * @author ChengChun
 * 
 * @see 修改记录：
 * @see [编号：日期_设计来源]，[修改人：***]，[方法名：***]
 */
public class P9101PBOC implements ItemProcessor<CcsAcct, T9002ToPBOCRptItem> {
	...
	public T9002ToPBOCRptItem process(CcsAcct acct) throws Exception {
		...
		try
		{
			...
			pboc.dataItem04_7121 = u9101PBOC.get7121(acct.getSetupDate());//账户拥有者信息提示
