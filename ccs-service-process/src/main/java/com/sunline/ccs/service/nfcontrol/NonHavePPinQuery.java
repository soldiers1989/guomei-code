...
/**
 * @see 类名：NonHavePPinQuery
 * @see 描述：是否有交易密码，没有true，有false
 *
 * @see 创建日期：   2015年6月24日 下午2:41:12
 * @author yuyang
 * 
 * @see 修改记录：
 ...
 */
@Service
public class NonHavePPinQuery implements IControlFieldStateQuery{
	...
	public boolean process(String cardNbr) throws ProcessException {
		logger.debug("查询是否有交易密码开始");
		Boolean bool = mmCardService.MS3502(cardNbr);
		logger.debug("查询是否有交易密码结束");
		//是否有交易密码，没有true，有false
		return !bool;
	}
