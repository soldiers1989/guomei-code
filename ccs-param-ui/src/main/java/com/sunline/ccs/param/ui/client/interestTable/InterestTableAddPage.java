 ...
 */
@Singleton
public class InterestTableAddPage extends SavePage {
  ...
  private URateDef uRateDef;
	...
	public IsWidget createPage() {
       ...
       editForm.setField(uInterestTable.IntTableId().required(true).setNewline(true),//.setLabel(""),//.setFieldWidth(250),
       ...
       KylinButton submitBtn = ClientUtils.creConfirmButton(new IClickEventListener()
       {
           ...
           public void onClick()
           {
               ...
               grid.getUi().endEdit();
                   ...
                   RPC.ajax("rpc/interestTableServer/addInterestTable", new RpcCallback<Data>()
                   {
                       @Override
