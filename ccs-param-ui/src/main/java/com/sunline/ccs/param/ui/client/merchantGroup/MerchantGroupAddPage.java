...
@Singleton
public class MerchantGroupAddPage extends SavePage {
	...
	public IsWidget createPage() {
        ...
        form.setField(uMerchantGroup.MerGroupId().required(true)
        ...
        KylinButton submitBtn = ClientUtils.creConfirmButton(new IClickEventListener()
        {
        	...
        	if(!form.valid()){
                ...
                RPC.ajax("rpc/merchantGroupServer/addMerchantGroup", new RpcCallback<Data>()
                {
                    @Override
