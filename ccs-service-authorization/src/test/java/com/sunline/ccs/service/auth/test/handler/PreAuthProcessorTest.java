...
//@Transactional
//public class PreAuthProcessorTest {
//	
//	@Autowired
...
//		msg.getBodyAttributes().put(25, "06");
...
//	
//	/**
//	 * 测试目的 :预授权完成撤销、预授权完成冲正
//	 * 测试基本要素：  MTI =0420 B003ProcCode = 00 ProcessId = authRetailProcessor
//	 * 测试判断标准: 返回responsCode = 00 通过
//	 *  
//	 */
//	@Test
//	public void TestPreAuthCompleteVoidReverseProcessor()
//	{
//		YakMessage msg = new YakMessage();
...
//	
//	/**
//	 * 测试目的 :[预授权或预授权完成]的撤销的冲正
//	 * 测试基本要素：  MTI =0420 B003ProcCode = 20  b025Entrycond =  06 ProcessId = authRetailProcessor
//	 * 测试判断标准: 返回responsCode = 00 通过
//	 *  
//	 */
//	@Test
//	public void TestPreAuthVoidReverseProcessor()
//	{
//		YakMessage msg = new YakMessage();
//		msg.getHeadAttributes().put(11, "0420");
//		msg.getBodyAttributes().put(2, "6200480204984167");
//		msg.getBodyAttributes().put(3, "20");
//		msg.getBodyAttributes().put(4, "1000");
//		msg.getBodyAttributes().put(6, "1000");
//		msg.getBodyAttributes().put(14, "1234");
//		msg.getBodyAttributes().put(18, "1001");
