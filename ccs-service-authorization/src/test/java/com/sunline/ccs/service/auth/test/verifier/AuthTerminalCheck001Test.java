...
//@Transactional
//public class AuthTerminalCheck001Test {
//	
//	@Autowired
...
//		// 交易终端类型
//		authProduct.terminalEnabled.put(AuthTransTerminal.ATM, AuthFlagAction.No);
//		
//		
//		
//		YakMessage yak = authService.authorize(msg);
//		Assert.assertEquals("58",yak.getBodyAttributes().get(39));
//		 
//	}
//
//}
