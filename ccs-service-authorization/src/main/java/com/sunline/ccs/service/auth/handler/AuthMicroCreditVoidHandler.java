...
/**
 * 
 * @see 类名：AuthMicroCreditVoidHandler
 * @see 描述：[小额贷]撤销 (单信息100，双信息200)
 *
 * @see 创建日期：   2015年6月24日下午3:30:31
 * @author liruilin
 * 
 * @see 修改记录：
 ...
 */
@Service
public class AuthMicroCreditVoidHandler extends AuthVoidReverseHandler {
	@Autowired
