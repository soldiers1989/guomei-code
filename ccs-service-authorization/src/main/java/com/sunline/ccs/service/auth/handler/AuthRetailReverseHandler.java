...
/**
 * 
 * @see 类名：AuthRetailReverseHandler
 * @see 描述：借记[消费]冲正
 *
 * @see 创建日期：   2015年6月24日下午3:31:22
 * @author liruilin
 * 
 * @see 修改记录：
 ...
 */
@Service
public class AuthRetailReverseHandler extends AuthVoidReverseHandler {
	@Autowired
	...
	protected Iterator<CcsAuthmemoO> findOriginalTrans(YakMessage request,
		...
		if (context.getTxnInfo().getInputSource() == InputSource.CUP 
				|| context.getTxnInfo().getInputSource() == InputSource.THIR 
