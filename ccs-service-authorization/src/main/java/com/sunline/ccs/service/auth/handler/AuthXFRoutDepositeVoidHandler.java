...
/**
 * 
 * @see 类名：AuthXFRoutDepositeVoidHandler
 * @see 描述：借记[转出]撤销 (单信息100，双信息200)
 *
 * @see 创建日期：   2015年6月24日下午3:42:25
 * @author liruilin
 * 
 * @see 修改记录：
 ...
 */
@Service
public class AuthXFRoutDepositeVoidHandler extends AuthVoidReverseHandler {
	@Autowired
